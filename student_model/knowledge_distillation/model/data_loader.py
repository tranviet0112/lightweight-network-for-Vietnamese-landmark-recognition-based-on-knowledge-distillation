...
def fetch_dataloader(types, params, path_dataset):
    """
    ...
    trainset = torchvision.datasets.ImageFolder(root=path_dataset, transform=train_transformer)
  
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=params.batch_size,
        shuffle=True, num_workers=params.num_workers, pin_memory=params.cuda)

    devset = torchvision.datasets.ImageFolder(root=path_dataset, transform=dev_transformer)
